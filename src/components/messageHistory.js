export default [
    ...
    {type: 'text', author: "Bot", data: { text: "Are we meeting today? Project has been already finished and I have results to show you."} },
    ...
    {type: 'text', author: "Bot", data: { text: "Actually everything was fine. I'm very excited to show this to our team."} },
    {type: 'text', author: "me", data: { text: "No forget the story. "} },
    {type: 'text', author: "Bot", data: { text: "You've got to have a story."} },
    {type: 'file', author: "me",
        data: {
            url: 'monsterImgUrl',
